...
namespace CRMEntities.Migrations
{
    ...
    [Migration("20220809105514_workorderNDUserIdFix")]
    partial class workorderNDUserIdFix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRMEntities.Models.UserColumn", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("CRMEntities.Models.UserColumn", b =>
                {
                    b.HasOne("CRMEntities.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
